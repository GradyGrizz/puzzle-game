...
expect('skeleton frame animation catalog includes mirrored left and right attacks',
  anims.skeleton.filter(a => a.kind === 'attackFrames').map(a => a.dir).sort().join(',') === 'left,right');
