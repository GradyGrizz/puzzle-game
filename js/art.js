...
// room-edge doorway punched through the border wall. type: open|shutter|lock|combat
doorway(ctx, x, y, t, side, type, open) {
  ...
  if (open) {
  ...
  } else if (type === 'shutter' || type === 'combat') {
    ...
    if (type === 'combat') {
      ...
      const cx = ox + Math.floor(ow / 2), cy = oy + Math.floor(oh / 2);
      ctx.fillRect(cx - 3, cy - 3, 6, 2); ctx.fillRect(cx - 1, cy - 5, 2, 10);
    }
  } else if (type === 'lock') {
...
ASSETS: {
  ...
  player_idle_up: 'art/player_idle/player_idle_up.png?v=july25-final-bob',
  player_idle_down: 'art/player_idle/player_idle_down.png?v=july25-final-bob',
  player_idle_left: 'art/player_idle/player_idle_left.png?v=july25-final-bob',
  player_idle_right: 'art/player_idle/player_idle_right.png?v=july25-final-bob',
  player_walk_right_review: 'art/animations/player_walk_right/sprite_sheet_review.png?v=july25-final-bob',
  ...
  skeleton_attack_right_03: 'art/animations/skeleton_attack_right/frame_03_lift.png',
  skeleton_attack_right_04: 'art/animations/skeleton_attack_right/frame_04_peak.png',
  skeleton_attack_right_05: 'art/animations/skeleton_attack_right/frame_05_down_start.png',
  skeleton_attack_right_06: 'art/animations/skeleton_attack_right/frame_06_mid_swing.png',
  skeleton_attack_right_07: 'art/animations/skeleton_attack_right/frame_07_strike.png',
  skeleton_attack_right_08: 'art/animations/skeleton_attack_right/frame_08_follow_through.png',
  skeleton_attack_right_09: 'art/animations/skeleton_attack_right/frame_09_recovery.png',
  skeleton_attack_right_10: 'art/animations/skeleton_attack_right/frame_10_idle_return.png',
  skeleton_attack_up_01: 'art/animations/skeleton_attack_up/frame_01.png',
  skeleton_attack_up_02: 'art/animations/skeleton_attack_up/frame_02.png',
  skeleton_attack_up_03: 'art/animations/skeleton_attack_up/frame_03.png',
  skeleton_attack_up_04: 'art/animations/skeleton_attack_up/frame_04.png',
  skeleton_attack_up_05: 'art/animations/skeleton_attack_up/frame_05.png',
  skeleton_attack_up_06: 'art/animations/skeleton_attack_up/frame_06.png',
  skeleton_attack_up_07: 'art/animations/skeleton_attack_up/frame_07.png',
  skeleton_attack_up_08: 'art/animations/skeleton_attack_up/frame_08.png',
  skeleton_attack_up_09: 'art/animations/skeleton_attack_up/frame_09.png',
  skeleton_attack_up_10: 'art/animations/skeleton_attack_up/frame_10.png',
  skeleton_attack_down_01: 'art/animations/skeleton_attack_down/frame_01.png',
  skeleton_attack_down_02: 'art/animations/skeleton_attack_down/frame_02.png',
  skeleton_attack_down_03: 'art/animations/skeleton_attack_down/frame_03.png',
  skeleton_attack_down_04: 'art/animations/skeleton_attack_down/frame_04.png',
  skeleton_attack_down_05: 'art/animations/skeleton_attack_down/frame_05.png',
  skeleton_attack_down_06: 'art/animations/skeleton_attack_down/frame_06.png',
  skeleton_attack_down_07: 'art/animations/skeleton_attack_down/frame_07.png',
  skeleton_attack_down_08: 'art/animations/skeleton_attack_down/frame_08.png',
  skeleton_attack_down_09: 'art/animations/skeleton_attack_down/frame_09.png',
  skeleton_attack_down_10: 'art/animations/skeleton_attack_down/frame_10.png',
...
hero(ctx, dir, frame, px, py, tile, pushing, idle) {
  ...
  const isDownWalk = dir === 'down';
  const walkSheet = this.img && (
    isUpWalk ? this.img.player_walk_up_review :
    isDownWalk ? this.img.player_walk_down_review :
    this.img.player_walk_right_review
  );
  if (!pushing && !idle &&
      (dir === 'right' || dir === 'left' || isUpWalk || isDownWalk) &&
      walkSheet && this._ready(walkSheet)) {
    const frameCount = isUpWalk ? 4 : isDownWalk ? 9 : 8;
    ...
    // July 25 playback: idle/passing frames stay high, while each full-stride
    // contact drops the whole body by one game-scale pixel.
  ...
  // Idle poses continue using the approved directional sprites.
